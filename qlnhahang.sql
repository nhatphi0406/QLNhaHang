...
CREATE TABLE `account` (
  ...
  `Username` char(20) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci NOT NULL,
  `PassWord` char(200) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci NOT NULL,
  `TypeUser` char(10) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `bophan` (
  `MaBP` int NOT NULL,
  `TenBP` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `dattiec` (
  `MaTiec` int NOT NULL,
  `TenTiec` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `Buoi` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`MaTiec`),
...
CREATE TABLE `dichvu` (
  `MaDV` int NOT NULL,
  `TenDV` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `hoadon` (
  ...
  `ThanhTien` decimal(18,0) DEFAULT NULL,
  `TinhTrang` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `khachhang` (
  `MaKH` int NOT NULL,
  `TenKH` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
  `GioiTinh` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `CMND` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SDT` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DiaChi` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `MaAcc` int NOT NULL,
  PRIMARY KEY (`MaKH`),
...
CREATE TABLE `monan` (
  `MaMA` int NOT NULL,
  `TenMA` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `DonGia` decimal(18,0) DEFAULT NULL,
  `Loai` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `DonViTinh` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `isDeleted` date DEFAULT NULL,
  PRIMARY KEY (`MaMA`),
...
CREATE TABLE `nhanvien` (
  `MaNV` int NOT NULL,
  `TenNV` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `SDT` char(11) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CMND` char(10) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MaBP` int DEFAULT NULL,
  `ChucVu` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `sanh` (
  `MaSanh` int NOT NULL,
  `TenSanh` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `Tang` char(10) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DonGia` decimal(18,0) DEFAULT NULL,
...
-- Dump completed on 2022-07-23 14:08:54
